function show() {
    ...
    d3.xml("/static/visualization_data/simpsons_logo.svg").mimeType("image/svg+xml").get(function (error, xml) {
    ...
    d3.json("/static/visualization_data/graph.json", function (error, graph) {
